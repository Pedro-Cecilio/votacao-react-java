-- Active: 1709668849959@@127.0.0.1@5432@testandosql@public
...
CREATE TABLE sessao_votacao_votos_positivos(
    ...
    FOREIGN KEY (sessao_votacao_id) REFERENCES sessao_votacao(id) ON DELETE CASCADE ON UPDATE CASCADE,
...
FOREIGN KEY (pauta_id) REFERENCES pauta(id) ON UPDATE CASCADE;
